...
const EditPost = () => {
    ...
    const canSave=[values.userId,values.content,values.title].every(Boolean) && requestStatus==="idle"
    ...
    const submitme = (e) => {
        ...
        if(canSave){
            try{
                ...
                dispatch(updatePost({title:values.title,body:values.content,userId:values.userId, id :postId,reactions:post.reactions})).unwrap();
